...
# Путь ко второму файлу статья 2.txt на вашем компьютере
file_path_article2 = 'D:/Projects/ДЗ5_ВерещакаАнатолійІванович/стаття 2.txt'

# Чтение содержимого второго файла
with open(file_path_article2, 'r', encoding='utf-8') as file:
...
print("Час виконання алгоритму Боєра-Мура для другого тексту (існуючий підрядок):",
      measure_boyer_moore(article2_text, existing_substring))
print("Час виконання алгоритму Боєра-Мура для другого тексту (вигаданий підрядок):",
      measure_boyer_moore(article2_text, non_existing_substring))

print("Час виконання алгоритму Кнута-Морріса-Пратта для другого тексту (існуючий підрядок):",
      measure_kmp(article2_text, existing_substring))
print("Час виконання алгоритму Кнута-Морріса-Пратта для другого тексту (вигаданий підрядок):",
      measure_kmp(article2_text, non_existing_substring))


print("Час виконання алгоритму Рабіна-Карпа для другого тексту (існуючий підрядок):",
      measure_rabin_karp(article2_text, existing_substring))
print("Час виконання алгоритму Рабіна-Карпа для другого тексту (вигаданий підрядок):",
      measure_rabin_karp(article2_text, non_existing_substring))
